...
public class JwtService {
    ...
    // Injete o valor da propriedade 'jwt.secret.key' do application.properties
    ...
    // Valida se o token pertence ao utilizador e não expirou
    ...
    private Key getSignInKey() {
        // Usa a variável injetada em vez da constante
